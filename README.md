...
- 🥃 [Worth a Shot](https://worth-a-shot.netlify.app/): Full-stack bar and nightclub finder web app with a [React front-end, an Express backend, and a PostgreSQL database](https://github.com/EmaleeSoto/capstone-worth-a-shot).
